...
namespace bigquery_storage_write_api_high_memory_allocation
{
    public sealed class LegacyBigQuerySaver
    {
        ...
        private static readonly Lazy<LegacyBigQuerySaver> Lazy = new Lazy<LegacyBigQuerySaver>(() => new LegacyBigQuerySaver());
        public static LegacyBigQuerySaver Instance => Lazy.Value;
